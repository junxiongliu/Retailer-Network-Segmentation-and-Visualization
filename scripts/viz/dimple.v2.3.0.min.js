! function(a, b) {
    ...
    else if ("function" == typeof define && define.amd) define(["d3"], function(c) {
    ...
    return b.axis = function(c, d, e, f, g, h) {
        this.chart = c, this.position = d, this.categoryFields = null === g || void 0 === g ? e : [].concat(g), this.measure = f, this.timeField = g, this.floatingBarWidth = 5, this.hidden = !1, this.showPercent = !1, this.colors = null, this.overrideMin = null, this.overrideMax = null, this.shapes = null, this.showGridlines = null, this.gridlineShapes = null, this.titleShape = null, this.dateParseFormat = null, this.tickFormat = null, this.timePeriod = null, this.timeInterval = 1, this.useLog = !1, this.logBase = 10, this.title = void 0, this.clamp = !0, this.ticks = null, this.fontSize = "10px", this.fontFamily = "sans-serif", this.autoRotateLabel = null === h || void 0 === h || h, this._slaves = [], this._scale = null, this._min = 0, this._max = 0, this._previousOrigin = null, this._origin = null, this._orderRules = [], this._groupOrderRules = [], this._draw = null, this._getAxisData = function() {
            ...
            } : null !== this.measure ? (c = Math.floor(Math.abs(this._max), 0).toString(), d = Math.floor(Math.abs(this._min), 0).toString(), e = Math.max(d.length, c.length), e > 3 ? (f = Math.min(Math.floor((e - 1) / 3), 4), g = "kmBT".substring(f - 1, f), h = e - 3 * f <= 1 ? 1 : 0, b = function(b) {
                return 0 === b ? 0 : a.format(",." + h + "f")(b / Math.pow(1e3, f)) + g
            }) : (h = Math.max(-(this._tick_step ? Math.floor(Math.log(this._tick_step) / Math.LN10) : 0), 0), b = a.format(",." + h + "f"))) : b = function(a) {
                return a
            }, b
            ...
            else if (this._hasCategories()) this.categoryFields.forEach(function(a, d) {
            ...
            var c;
            return c = null === this.dateParseFormat || void 0 === this.dateParseFormat ? isNaN(b) ? Date.parse(b) : new Date(b) : a.timeParse(this.dateParseFormat)(b)
            ...
            var d, e, f, g, h = [],
                ...
                j = function(a, c, d) {
                    ...
                    for (e = 0; e < h.length; e += 1)
                        if (l = a._parseDate(h[e][g]), null !== l && void 0 !== l && isNaN(l)) {
                            k = !1;
                            break
                        }
                    return k || a.chart.series.forEach(function(b) {
                        b[c] === a && b[d]._hasMeasure() && (i = b[d].measure, j = !0)
                    }, this), f = a._orderRules.concat({
                        ordering: i,
                        desc: j
                    }), b._getOrderedList(h, g, f)
                };
        ...
        this.svg = c, this.x = "10%", this.y = "10%", this.width = "80%", this.height = "80%", this.data = d, this.noFormats = !1, this.axes = [], this.series = [], this.legends = [], this.storyboard = null, this.titleShape = null, this.shapes = null, this.ease = a.easeCubicInOut, this.staggerDraw = !1, this.transition = {}, this._group = c.append("g"), this._group.attr("class", "dimple-chart"), this._gridlines_group = this._group.insert("g"), this._gridlines_group.attr("class", "dimple-gridlines-group"), this._axis_group = this._group.insert("g"), this._axis_group.attr("class", "dimple-axis-group"), this._tooltipGroup = null, this._assignedColors = {}, this._assignedClasses = {}, this._nextColor = 0, this._nextClass = 0, this._axisIndex = function(a, b) {
            ...
            this.storyboard && this.storyboard.categoryFields.length > 0 && (y = this.storyboard.categoryFields[0], z = b._getOrderedList(J, y, this.storyboard._orderRules)), h && h._hasCategories() && h._hasMeasure() && (C = h.categoryFields[0], D = b._getOrderedList(J, C, h._orderRules.concat([{
                ...
                if ("" !== y && (i = z.indexOf(a[y]) - z.indexOf(b[y])), "" !== C && 0 === i && (i = D.indexOf(a[C]) - D.indexOf(b[C])), "" !== E && 0 === i && (i = F.indexOf(a[E]) - F.indexOf(b[E])), "" !== G && 0 === i && (i = H.indexOf(a[G]) - F.indexOf(b[G])), A && A.length > 0 && 0 === i)
                    for (c = [].concat(A), i = 0, e = 0; e < B.length; e += 1) {
                    ...
                    if (a.x && a.y) {
                        for (i.pop(), k = this._getData(h, ["__dimple_placeholder__"].concat(i), a.aggregate, a._orderRules, a._isStacked(), a.x, a.y, a.z, a.p, a.c), b = 0; b < j.length; b += 1)
                            for (d = ["__dimple_placeholder__"].concat(j[b].aggField), d.pop(), a.x && a.x._hasCategories() && (d = d.concat(j[b].xField)), a.y && a.y._hasCategories() && (d = d.concat(j[b].yField)), e = d.join("|"), c = 0; c < k.length; c += 1)
                                if (f = [].concat(k[c].aggField), a.x && a.x._hasCategories() && (f = f.concat(k[c].xField)), a.y && a.y._hasCategories() && (f = f.concat(k[c].yField)), g = f.join("|"), e === g) {
                        ...
                        for (b = 0; b < j.length; b += 1) j[b].pieKey = "All", j[b].value = j.pValue, l[j[b].pieKey] || (l[j[b].pieKey] = {
                            total: 0,
                            angle: m
        ...
        }, this._handleTransition = function(a, c, d, e) {
            var f = null;
            return 0 === c ? f = a : (f = a.transition().duration(c).delay(d._getDelay(c, d, e)), b._ease(f, d.ease)), f
            ...
            return void 0 !== c && null !== c && c !== !1 || this._getSeriesData(), this.axes.forEach(function(a) {
                ...
                if (a._min = 0, a._max = 0, e = [], a._hasMeasure()) {
                    ...
                    b._deepMatch(a) && null !== b[a.position].timeField && void 0 !== b[a.position].timeField && e.indexOf(b[a.position].timeField) === -1 && e.push(b[a.position].timeField)
                    ...
                    b._deepMatch(a) && null !== b[a.position].categoryFields[0] && void 0 !== b[a.position].categoryFields[0] && e.indexOf(b[a.position].categoryFields[0]) === -1 && e.push(b[a.position].categoryFields[0])
                }, this), a._getAxisData().forEach(function(a) {
                    e.forEach(function(b) {
                        d.indexOf(a[b]) === -1 && d.push(a[b])
                    }, this)
        ...
        this.chart = c, this.series = i, this.x = d, this.y = e, this.width = f, this.height = g, this.horizontalAlign = h, this.shapes = null, this.fontSize = "10px", this.fontFamily = "sans-serif", this._draw = function() {
            ...
            this.shapes && this.shapes.remove(), c = this.chart._group.selectAll(".dimple-dont-select-any").data(d).enter().append("g").attr("class", function(a) {
                ...
                l.chart.noFormats || a.style("font-family", l.fontFamily).style("font-size", l._getFontSize()).style("shape-rendering", "crispEdges")
            }).each(function() {
                var a = this.getBBox();
            ...
            }).attr("height", j).attr("width", i), f = (f < j ? j : f) + l._getVerticalPadding(), e += i + l._getHorizontalPadding(), c.each(function(c) {
                ...
                }).attr("x", "left" === l.horizontalAlign ? l._xPixels() + g : l._xPixels() + (l._widthPixels() - g - e)).attr("y", l._yPixels() + h).attr("height", j).attr("width", i).call(function(a) {
                    l.chart.noFormats || a.style("fill", c.fill).style("stroke", c.stroke).style("opacity", c.opacity).style("shape-rendering", "crispEdges")
                }), g += e)
            }), this.shapes = c
            ...
            return this.series && this.series.forEach(function(b) {
                ...
                c.forEach(function(c) {
                    ...
                    e === -1 && b.chart._assignedColors[f] && (a.push({
                        key: f,
        ...
        this.chart = a, this.x = c, this.y = d, this.z = e, this.c = f, this.p = g, this.plot = h, this.categoryFields = b, this.aggregate = i, this.stacked = j, this.barGap = .2, this.clusterBarGap = .1, this.lineWeight = 2, this.lineMarkers = !1, this.afterDraw = null, this.interpolation = "linear", this.tooltipFontSize = "10px", this.tooltipFontFamily = "sans-serif", this.radius = "auto", this._group = a._group.append("g"), this._group.attr("class", "dimple-series-group-" + a.series.length), this._eventHandlers = [], this._positionData = [], this._orderRules = [], this._axisBounds = function(a) {
            ...
            return "x" === a ? (f = this.x, g = this.y) : "y" === a ? (f = this.y, g = this.x) : "z" === a ? f = this.z : "p" === a ? f = this.p : "c" === a && (f = this.c), f.showPercent ? j.forEach(function(a) {
                ...
                var e = a[c].join("/"),
                    f = d.indexOf(e);
                f === -1 && (d.push(e), f = d.length - 1), void 0 === h[f] && (h[f] = {
                    min: 0,
                    max: 0
        ...
        null !== b && void 0 !== b && (b = [].concat(b)), this.chart = a, this.categoryFields = b, this.autoplay = !0, this.frameDuration = 3e3, this.storyLabel = null, this.onTick = null, this.fontSize = "10px", this.fontFamily = "sans-serif", this._frame = 0, this._animationTimer = null, this._categories = [], this._cachedCategoryFields = [], this._orderRules = [], this._drawText = function() {
            var b = this,
                c = 0;
            b.storyLabel || (b.chart.axes.forEach(function(a) {
                "x" === a.position && (c += 1)
            }, b), b.storyLabel = b.chart._group.append("text").attr("class", "dimple-storyboard-label").attr("opacity", 1).attr("x", b.chart._xPixels() + .9 * b.chart._widthPixels()).attr("y", b.chart._yPixels() + (b.chart._heightPixels() / 35 > 10 ? b.chart._heightPixels() / 35 : 10) * (c > 1 ? 1.25 : -1)).call(function(c) {
                a.noFormats || c.style("font-family", b.fontFamily).style("font-size", b._getFontSize())
            })), b.storyLabel.text(b.categoryFields.join("\\") + ": " + b.getFrameValue())
            ...
            return this._categoryFields !== this._cachedCategoryFields && (this._categories = [], this.chart._getAllData().forEach(function(a) {
                ...
                null !== this.categoryFields && (this.categoryFields.forEach(function(b, d) {
                    d > 0 && (c += "/"), c += a[b]
                }, this), b = this._categories.indexOf(c), b === -1 && (this._categories.push(c), b = this._categories.length - 1))
        ...
        draw: function(c, d, e) {
            var f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D = d._positionData,
                ...
                O = function(a, f) {
                    b._drawMarkers(a, c, d, e, G, I, M(a), N(a), f)
                },
                P = function(a, e) {
                    var f;
                ...
                Q = function(c, e) {
                    var f = a.line().x(function(a) {
                        return d.x._hasCategories() || !e ? a.x : d.x[e]
                    }).y(function(a) {
                        return d.y._hasCategories() || !e ? a.y : d.y[e]
                    });
                    return b._interpolate(f, c), f
                },
                R = function(a, b) {
            ...
            for (f = "step" === d.interpolation ? "step-after" : d.interpolation, p = b._getSeriesOrder(d.data || c.data, d), d.c && (d.x._hasCategories() && d.y._hasMeasure() || d.y._hasCategories() && d.x._hasMeasure()) && (I = !0), d.x._hasCategories() ? (B = "x", C = "y") : d.y._hasCategories() && (B = "y", C = "x"), g = 0; g < D.length; g += 1) {
                ...
                l === -1 && (l = E.length, E.push({
                    ...
                    entry: {},
                    exit: {},
                    group: B && D[g][B + "Field"] && D[g][B + "Field"].length >= 2 ? D[g][B + "Field"][0] : "All"
                })), E[l].data.push(D[g])
            }
            for (p && E.sort(function(a, c) {
                    return b._arrayIndexCompare(p, a.key, c.key)
                }), g = 0; g < E.length; g += 1) {
                for (E[g].data.sort(b._getSeriesSortPredicate(c, d, p)), h = 0; h < E[g].data.length; h += 1) E[g].points.push({
                    x: P("x", E[g].data[h]),
                    y: P("y", E[g].data[h])
                }), B && (J[E[g].group] || (J[E[g].group] = {}), J[E[g].group][E[g].points[E[g].points.length - 1][B]] = d[C]._origin);
                q = E[g].points, "step" === d.interpolation && q.length > 1 && B && (d.x._hasCategories() ? (q.push({
                    x: 2 * q[q.length - 1].x - q[q.length - 2].x,
                    y: q[q.length - 1].y
                }), J[E[g].group][q[q.length - 1][B]] = d[C]._origin) : d.y._hasCategories() && (q = [{
                    x: q[0].x,
                    y: 2 * q[0].y - q[1].y
                }].concat(q), J[E[g].group][q[0][B]] = d[C]._origin, E[g].points = q))
            }
            for (t in J)
            ...
            c._tooltipGroup && c._tooltipGroup.remove(), F = d.shapes ? d.shapes.data(E, function(a) {
                return a.key
            }) : d._group.selectAll("." + G).data(E, function(a) {
                return a.key
            }), m = F.enter().append("path").attr("id", function(a) {
                return b._createClass([a.key])
            }).attr("class", function(a) {
                return G + " dimple-line " + a.keyString + " " + c.customClassList.areaSeries + " " + a.css
            }).attr("d", function(a) {
                return a.entry
            }).call(function(a) {
                c.noFormats || a.attr("opacity", function(a) {
                    return I ? 1 : a.color.opacity
                }).style("fill", function(a) {
                    return I ? "url(#" + b._createClass(["fill-area-gradient-" + a.keyString]) + ")" : a.color.fill
                }).style("stroke", function(a) {
                    return I ? "url(#" + b._createClass(["stroke-area-gradient-" + a.keyString]) + ")" : a.color.stroke
                }).style("stroke-width", d.lineWeight)
            }).each(function(a) {
                a.markerData = a.data, O(a, this)
            }), n = c._handleTransition(F.merge(m), e, c).attr("d", function(a) {
                return a.update
            }).each(function(a) {
                a.markerData = a.data, O(a, this)
            }), o = c._handleTransition(F.exit(), e, c).attr("d", function(a) {
                return a.exit
            }).each(function(a) {
                a.markerData = [], O(a, this)
            }), b._postDrawHandling(d, n, o, e), d.shapes = d._group.selectAll("." + G)
        }
    }, b.plot.bar = {
        stacked: !0,
        grouped: !1,
        ...
        draw: function(a, c, d) {
            var e, f, g, h = c._positionData,
                ...
                m = "none";
            c.x._hasCategories() && c.y._hasCategories() ? m = "both" : c.x._hasCategories() ? m = "x" : c.y._hasCategories() && (m = "y"), a._tooltipGroup && a._tooltipGroup.remove(), i = c.shapes ? c.shapes.data(h, function(a) {
                return a.key
            }) : c._group.selectAll("." + j.join(".")).data(h, function(a) {
                return a.key
            }), e = i.enter().append("rect").attr("id", function(a) {
                return b._createClass([a.key])
            }).attr("class", function(c) {
                var d = [];
                return d = d.concat(c.aggField), d = d.concat(c.xField), d = d.concat(c.yField), j.join(" ") + " " + b._createClass(d) + " " + a.customClassList.barSeries + " " + b._helpers.css(c, a)
            }).attr("x", function(d) {
                var e = c.x._previousOrigin;
                return "x" === m ? e = b._helpers.x(d, a, c) : "both" === m && (e = b._helpers.cx(d, a, c)), e
            }).attr("y", function(d) {
                var e = c.y._previousOrigin;
                return "y" === m ? e = b._helpers.y(d, a, c) : "both" === m && (e = b._helpers.cy(d, a, c)), e
            }).attr("width", function(d) {
                return "x" === m ? b._helpers.width(d, a, c) : 0
            }).attr("height", function(d) {
                return "y" === m ? b._helpers.height(d, a, c) : 0
            }).on("mouseover", function(d) {
                b._showBarTooltip(d, this, a, c)
            }).on("mouseleave", function(d) {
                b._removeTooltip(d, this, a, c)
            }).call(function(d) {
                a.noFormats || d.attr("opacity", function(d) {
            ...
            }), f = a._handleTransition(i.merge(e), d, a, c).attr("x", function(d) {
                return k ? b._helpers.cx(d, a, c) - c.x.floatingBarWidth / 2 : b._helpers.x(d, a, c)
            }).attr("y", function(d) {
                return l ? b._helpers.cy(d, a, c) - c.y.floatingBarWidth / 2 : b._helpers.y(d, a, c)
            }).attr("width", function(d) {
                return k ? c.x.floatingBarWidth : b._helpers.width(d, a, c)
            }).attr("height", function(d) {
                return l ? c.y.floatingBarWidth : b._helpers.height(d, a, c)
            }).call(function(d) {
                a.noFormats || d.attr("fill", function(d) {
                    return b._helpers.fill(d, a, c)
                }).attr("stroke", function(d) {
                    return b._helpers.stroke(d, a, c)
                })
            }), g = a._handleTransition(i.exit(), d, a, c).attr("x", function(d) {
                var e = c.x._origin;
                return "x" === m ? e = b._helpers.x(d, a, c) : "both" === m && (e = b._helpers.cx(d, a, c)), e
            }).attr("y", function(d) {
                var e = c.y._origin;
                ...
                return "y" === m ? b._helpers.height(d, a, c) : 0
            }), b._postDrawHandling(c, f, g, d), c.shapes = c._group.selectAll("." + j.join("."))
        }
    }, b.plot.bubble = {
        stacked: !1,
        grouped: !1,
        ...
        draw: function(a, c, d) {
            ...
            a._tooltipGroup && a._tooltipGroup.remove(), i = c.shapes ? c.shapes.data(h, function(a) {
                return a.key
            }) : c._group.selectAll("." + j.join(".")).data(h, function(a) {
                return a.key
            }), e = i.enter().append("circle").attr("id", function(a) {
                return b._createClass([a.key])
            }).attr("class", function(c) {
                var d = [];
                return d = d.concat(c.aggField), d = d.concat(c.xField), d = d.concat(c.yField), d = d.concat(c.zField), j.join(" ") + " " + b._createClass(d) + " " + a.customClassList.bubbleSeries + " " + b._helpers.css(c, a)
            }).attr("cx", function(d) {
            ...
            }), f = a._handleTransition(i.merge(e), d, a, c).attr("cx", function(d) {
            ...
            }), g = a._handleTransition(i.exit(), d, a, c).attr("r", 0).attr("cx", function(d) {
        ...
        draw: function(c, d, e) {
            var f, g, h, i, j, k, l, m, n, o, p, q = d._positionData,
                ...
                y = function(a, f) {
                    b._drawMarkers(a, c, d, e, t, v, w(a), x(a), f)
                },
                z = function(a, e) {
                    var f;
            ...
            for (p && r.sort(function(a, c) {
                    return b._arrayIndexCompare(p, a.key, c.key)
                }), g = 0; g < r.length; g += 1) {
                for (r[g].data.sort(b._getSeriesSortPredicate(c, d, p)), v && b._addGradient(r[g].key, "fill-line-gradient-" + r[g].keyString, d.x._hasCategories() ? d.x : d.y, q, c, e, "fill"), h = 0; h < r[g].data.length; h += 1) r[g].points.push({
                    x: z("x", r[g].data[h]),
                    y: z("y", r[g].data[h])
                });
                "step" === d.interpolation && r[g].points.length > 1 && (d.x._hasCategories() ? r[g].points.push({
                    x: 2 * r[g].points[r[g].points.length - 1].x - r[g].points[r[g].points.length - 2].x,
                    y: r[g].points[r[g].points.length - 1].y
                }) : d.y._hasCategories() && (r[g].points = [{
                    x: r[g].points[0].x,
                    y: 2 * r[g].points[0].y - r[g].points[1].y
                }].concat(r[g].points))), r && r[g] && r[g].points && 1 === r[g].points.length && r[g].points.push({
                    x: r[g].points[0].x,
                    y: r[g].points[0].y
                }), r[g].entry = A(f, "_previousOrigin")(r[g].points), r[g].update = A(f)(r[g].points), r[g].exit = A(f, "_origin")(r[g].points), r[g].color = c.getColor(r[g].key.length > 0 ? r[g].key[r[g].key.length - 1] : "All"), r[g].css = c.getClass(r[g].key.length > 0 ? r[g].key[r[g].key.length - 1] : "All")
            }
            c._tooltipGroup && c._tooltipGroup.remove(), s = d.shapes ? d.shapes.data(r, function(a) {
                return a.key
            }) : d._group.selectAll("." + t).data(r, function(a) {
                return a.key
            }), m = s.enter().append("path").attr("id", function(a) {
                return b._createClass([a.key])
            }).attr("class", function(a) {
                return t + " dimple-line " + a.keyString + " " + c.customClassList.lineSeries + " " + a.css
            }).attr("d", function(a) {
                return a.entry
            }).call(function(a) {
                c.noFormats || a.attr("opacity", function(a) {
                    return v ? 1 : a.color.opacity
                }).style("fill", "none").style("stroke", function(a) {
                    return v ? "url(#" + b._createClass(["fill-line-gradient-" + a.keyString]) + ")" : a.color.stroke
                }).style("stroke-width", d.lineWeight)
            }).each(function(a) {
                a.markerData = a.data, y(a, this)
            }), n = c._handleTransition(s.merge(m), e, c).attr("d", function(a) {
                return a.update
            }).each(function(a) {
                a.markerData = a.data, y(a, this)
            }), o = c._handleTransition(s.exit(), e, c).attr("d", function(a) {
                return a.exit
            }).each(function(a) {
                a.markerData = [], y(a, this)
            }), b._postDrawHandling(d, n, o, e), d.shapes = d._group.selectAll("." + t)
        }
    }, b.plot.pie = {
        stacked: !1,
        grouped: !1,
        ...
        draw: function(c, d, e) {
            var f, g, h, i = d._positionData,
                ...
                n = function(a) {
                    var c = 0;
                    return d.innerRadius && (c = b._parsePosition(d.innerRadius, l(a))), Math.max(c, 0)
                },
                o = function(b) {
                    var c;
                    return (c = a.arc().innerRadius(n(b)).outerRadius(m(b)))(b)
                },
                p = function(b) {
                    b.innerRadius = n(b), b.outerRadius = m(b);
                    var c, d = a.interpolate(this._current, b);
                    return c = a.arc().innerRadius(function(a) {
            ...
            c._tooltipGroup && c._tooltipGroup.remove(), j = d.shapes ? d.shapes.data(i, function(a) {
                return a.key
            }) : d._group.selectAll("." + k.join(".")).data(i, function(a) {
                return a.key
            }), f = j.enter().append("path").attr("id", function(a) {
                return b._createClass([a.key])
            }).attr("class", function(a) {
                var d = [];
                return d = d.concat(a.aggField), d = d.concat(a.pField), k.join(" ") + " " + b._createClass(d) + " " + c.customClassList.pieSeries + " " + b._helpers.css(a, c)
            }).attr("d", o).on("mouseover", function(a) {
            ...
            }).attr("transform", q(!0)).each(function(a) {
                this._current = a, a.innerRadius = n(a), a.outerRadius = m(a)
            }), g = c._handleTransition(j.merge(f), e, c, d).call(function(a) {
                e && e > 0 ? a.attrTween("d", p) : a.attr("d", o), c.noFormats || a.attr("fill", function(a) {
                    return b._helpers.fill(a, c, d)
                }).attr("stroke", function(a) {
                    return b._helpers.stroke(a, c, d)
                })
            }).attr("transform", q(!1)), h = c._handleTransition(j.exit(), e, c, d).attr("transform", q(!0)).attr("d", o), b._postDrawHandling(d, g, h, e), d.shapes = d._group.selectAll("." + k.join("."))
        }
        ...
        e.forEach(function(a) {
            k.indexOf(a[l]) === -1 && a.aggField.join("_") === i.join("_") && k.push(a[l])
            ...
            for (d = 0; d < e.length; d += 1)
                if (e[d].aggField.join("_") === i.join("_") && e[d][l].join("_") === a.join("_")) {
                    c = e[d];
                    break
                }
            n.push({
                offset: Math.round(b / (k.length - 1) * 100) + "%",
                color: c[h]
            })
        ...
        e.lineMarkers && (i = null === e._markerBacks || void 0 === e._markerBacks || void 0 === e._markerBacks[c.keyString] ? e._group.selectAll("." + l.join(".")).data(c.markerData) : e._markerBacks[c.keyString].data(c.markerData, function(a) {
            return a.key
        ...
        }).attr("r", 0).attr("fill", "white").attr("stroke", "none"), d._handleTransition(i.merge(k), f, d).attr("cx", function(a) {
        ...
        l = null === e._markers || void 0 === e._markers || void 0 === e._markers[c.keyString] ? e._group.selectAll("." + o.join(".")).data(c.markerData) : e._markers[c.keyString].data(c.markerData, function(a) {
            return a.key
            ...
            return e.y._hasCategories() ? b._helpers.cy(a, d, e) : e.y._previousOrigin
        }).attr("r", 0).attr("opacity", e.lineMarkers || c.data.length < 2 ? c.color.opacity : 0).call(function(a) {
        ...
        }), d._handleTransition(l.merge(n), f, d).attr("cx", function(a) {
            return b._helpers.cx(a, d, e)
        }).attr("cy", function(a) {
            return b._helpers.cy(a, d, e)
        }).attr("r", 2 + e.lineWeight).attr("opacity", e.lineMarkers || c.data.length < 2 ? c.color.opacity : 0).call(function(a) {
            d.noFormats || a.attr("fill", "white").style("stroke-width", e.lineWeight).attr("stroke", function(a) {
                return h ? b._helpers.fill(a, d, e) : c.color.stroke
            })
        ...
        return null !== e && void 0 !== e && e.length > 0 && (null !== c.c && void 0 !== c.c && c.c._hasMeasure() && d.push({
            ...
            desc: !0
        }), c.y._hasMeasure() && d.push({
            ordering: c.y.measure,
            desc: !0
        }), f = b._getOrderedList(a, e, d)), f
        ...
        return (!b || b < 0) && (b = a.clientHeight), b
    }, b._parentWidth = function(a) {
        var b = a.getBoundingClientRect().width;
        return (!b || b < 0) && (b = a.clientWidth), b
    ...
    }, b._postDrawHandling = function(a, b, c, d) {
        0 === d ? (b.each(function(b, c) {
            a.afterDraw && a.afterDraw(this, b, c)
        }), c.remove()) : (b.on("end", function(b, c) {
            a.afterDraw && a.afterDraw(this, b, c)
        }), c.call(function() {
            a.shapes && a.shapes.exit().remove()
        }))
        ...
        return b = null !== b && void 0 !== b ? [].concat(b) : [], a.forEach(function(a) {
            ...
            d.forEach(function(c, d) {
                e === -1 && (g = !0, b.forEach(function(b) {
                    g = g && a[b] === c[b]
                }, this), g && (e = d))
            }, this), e !== -1 ? f = d[e] : (b.forEach(function(b) {
                f[b] = a[b]
            }, this), d.push(f), e = d.length - 1), c.forEach(function(c) {
                b.indexOf(c) === -1 && (void 0 === f[c] && (f[c] = []), f[c] = f[c].concat(a[c]))
            }, this), d[e] = f
        }, this), d
        ...
        null !== d._tooltipGroup && void 0 !== d._tooltipGroup && d._tooltipGroup.remove(), d._tooltipGroup = d.svg.append("g"), e.p || (k = e._isStacked() ? 1 : r / 2, e.x._hasCategories() || null === v.y || d._tooltipGroup.append("line").attr("class", "dimple-tooltip-dropline " + d.customClassList.tooltipDropLine).attr("x1", p < e.x._origin ? p + k : p + r - k).attr("y1", q < v.y ? q + s : q).attr("x2", p < e.x._origin ? p + k : p + r - k).attr("y2", q < v.y ? q + s : q).call(function(a) {
            d.noFormats || a.style("fill", "none").style("stroke", u).style("stroke-width", 2).style("stroke-dasharray", "3, 3").style("opacity", t)
        }).transition().delay(n / 2).duration(n / 2).ease(a.easeLinear).attr("y2", q < v.y ? v.y - 1 : v.y + 1), k = e._isStacked() ? 1 : s / 2, e.y._hasCategories() || null === v.x || d._tooltipGroup.append("line").attr("class", "dimple-tooltip-dropline " + d.customClassList.tooltipDropLine).attr("x1", p < v.x ? p + r : p).attr("y1", q < e.y._origin ? q + k : q + s - k).attr("x2", p < v.x ? p + r : p).attr("y2", q < e.y._origin ? q + k : q + s - k).call(function(a) {
            d.noFormats || a.style("fill", "none").style("stroke", u).style("stroke-width", 2).style("stroke-dasharray", "3, 3").style("opacity", t)
            ...
            d.noFormats || a.style("font-family", e.tooltipFontFamily).style("font-size", e._getTooltipFontSize())
        }), f.each(function() {
        ...
        }), g.attr("x", -l).attr("y", -l).attr("height", Math.floor(z + l) - .5).attr("width", A + 2 * l).attr("rx", 5).attr("ry", 5).call(function(a) {
            d.noFormats || a.style("fill", x).style("stroke", w).style("stroke-width", 2).style("opacity", .95)
        ...
        null !== e._tooltipGroup && void 0 !== e._tooltipGroup && e._tooltipGroup.remove(), e._tooltipGroup = e.svg.append("g"), e._tooltipGroup.append("circle").attr("class", "dimple-line-marker-circle " + e.customClassList.lineMarkerCircle).attr("cx", o).attr("cy", p).attr("r", q).call(function(a) {
            e.noFormats || a.attr("opacity", 0).style("fill", "none").style("stroke", s).style("stroke-width", 1)
        }).transition().duration(m / 2).ease(a.easeLinear).attr("r", q + f.lineWeight + 2).call(function(a) {
            e.noFormats || a.attr("opacity", 1).style("stroke-width", 2)
        }), null !== t.y && e._tooltipGroup.append("line").attr("class", "dimple-tooltip-dropline " + e.customClassList.tooltipDropLine).attr("x1", o).attr("y1", p < t.y ? p + q + f.lineWeight + 2 : p - q - f.lineWeight - 2).attr("x2", o).attr("y2", p < t.y ? p + q + f.lineWeight + 2 : p - q - f.lineWeight - 2).call(function(a) {
            e.noFormats || a.style("fill", "none").style("stroke", s).style("stroke-width", 2).style("stroke-dasharray", "3, 3").style("opacity", r)
        }).transition().delay(m / 2).duration(m / 2).ease(a.easeLinear).attr("y2", p < t.y ? t.y - 1 : t.y + 1), null !== t.x && e._tooltipGroup.append("line").attr("class", "dimple-tooltip-dropline " + e.customClassList.tooltipDropLine).attr("x1", o < t.x ? o + q + f.lineWeight + 2 : o - q - f.lineWeight - 2).attr("y1", p).attr("x2", o < t.x ? o + q + f.lineWeight + 2 : o - q - f.lineWeight - 2).attr("y2", p).call(function(a) {
            e.noFormats || a.style("fill", "none").style("stroke", s).style("stroke-width", 2).style("stroke-dasharray", "3, 3").style("opacity", r)
        }).transition().delay(m / 2).duration(m / 2).ease(a.easeLinear).attr("x2", o < t.x ? t.x - 1 : t.x + 1), g = e._tooltipGroup.append("g"), h = g.append("rect").attr("class", "dimple-tooltip " + e.customClassList.tooltipBox), g.selectAll(".dont-select-any").data(z).enter().append("text").attr("class", "dimple-tooltip " + e.customClassList.tooltipLabel).text(function(a) {
            return a
        }).call(function(a) {
            e.noFormats || a.style("font-family", f.tooltipFontFamily).style("font-size", f._getTooltipFontSize())
        }), g.each(function() {
        ...
        }), h.attr("x", -k).attr("y", -k).attr("height", Math.floor(w + k) - .5).attr("width", x + 2 * k).attr("rx", 5).attr("ry", 5).call(function(a) {
            e.noFormats || a.style("fill", v).style("stroke", u).style("stroke-width", 2).style("opacity", .95)
